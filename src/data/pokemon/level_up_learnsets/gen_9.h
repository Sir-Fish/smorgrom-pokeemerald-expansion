...
static const struct LevelUpMove sPucklingLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_LEAFAGE),
...
static const struct LevelUpMove sWingblownLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 5, MOVE_LEAFAGE),
    LEVEL_UP_MOVE( 9, MOVE_PECK),
    ...
    LEVEL_UP_MOVE( 34, MOVE_LASH_OUT),
...
static const struct LevelUpMove sGrimkeeperLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SLASH),
...
static const struct LevelUpMove sClickittyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
    LEVEL_UP_MOVE( 1, MOVE_HONE_CLAWS),
...
static const struct LevelUpMove sFelinuxLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_CHARGE),
    LEVEL_UP_MOVE( 1, MOVE_DISCHARGE),
    LEVEL_UP_MOVE( 1, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE( 1, MOVE_SLUDGE_WAVE),
