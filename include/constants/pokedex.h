...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_PUCKLING,
    NATIONAL_DEX_WINGBLOWN,
    NATIONAL_DEX_GRIMKEEPER,
    NATIONAL_DEX_CLICKITTY,
    NATIONAL_DEX_FELINUX,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_FELINUX
